        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown"><a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#" style="color:rgba(0,0,0,0.5);">Employees&nbsp;</a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="add-new-employee.php">Add New Employee</a><a class="dropdown-item" role="presentation" href="employees.php">View Employees</a></div>
                </li>
                <li class="dropdown"><a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#">Cards&nbsp;</a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="add-new-card.php">Add New Card</a><a class="dropdown-item" role="presentation" href="add-new-card.php"></a><a class="dropdown-item" role="presentation" href="cards.php">View Cards</a></div>
                </li>
                <li class="dropdown"><a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#">Sewers&nbsp;</a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="add-new-sewer.php">Add New Sewer</a><a class="dropdown-item" role="presentation" href="sewers.php">View Sewers</a></div>
                </li>
                <li class="dropdown"><a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#">Reports&nbsp;</a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="sewer-by-date.php">View Sewers By Date</a><a class="dropdown-item" role="presentation" href="print-sewer-by-date.php">Print Sewers By Date</a></div>
                </li>
                <li class="dropdown"><a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#">Others&nbsp;</a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="about.php">About</a></div>
                </li>
            </ul>
        </div>
    </div>
