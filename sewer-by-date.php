    ...
    <div class="row">
        <div class="col-12" id="page-heading">
            ...
            <form method="get" action="sewer-by-date.php">
                <div class="form-group"><input class="form-control" type="date" name="date" id="date"
                                               <?php echo (isset($_GET['date']) && !empty($_GET['date'])) ? "value='" . $_GET['date'] . "'" : null; ?>style="width:100%;">
                    <div style="height:10px;"></div>
                    <button class="btn btn-primary float-right" type="submit" name="sewerFilterSubmit"
                            value="sewerFilterSubmit">View
                    </button>
                </div>
            </form>
        </div>
        <div class="col col-12" id="page-form" style="padding-top:20px;">
            <div id="ajaxTable">
