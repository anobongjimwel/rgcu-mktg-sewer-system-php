...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col" id="page-form" style="padding-top:20px;">
            <label>Employee Name:</label><input name="empname" onkeydown="enter(event)" id="empname"
                                                class="form-control form-control-sm" type="text" style="width:100%;">
            <div style="height:10px;"></div>
            <div class="btn-group float-right" role="group">
                <button class="btn btn-danger" type="button">Cancel</button>
                <button class="btn btn-success" type="button" onclick="addEmployee()">Submit</button>
            </div>
        </div>
    </div>
</div>
