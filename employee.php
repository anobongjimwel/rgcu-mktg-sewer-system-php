...
<?php include_once "assets/includes/navbar.php"?>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col" style="padding-top:10px;"><div>
        <table class='table table-hover table-fluid table-borderless' id="table_employees">
            ...
            <tbody>
                ...
                -->
                <?php
                    $query = $db->query("SELECT s.card_number as cn, t.id as id, s.item as item, c.item as card, st.category as activity, t.date as date FROM tasks t LEFT JOIN employees e ON t.employee = e.id LEFT JOIN sewers s ON t.sewer_id = s.id LEFT JOIN cards c ON s.card_number = c.id LEFT JOIN statuses st ON t.status = st.id WHERE t.employee = 16 ORDER BY t.date desc, s.card_number desc, t.id desc, st.id asc LIMIT 100");
                    if ($query->rowCount()>1) {
