...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col" id="page-form" style="padding-top:20px;">
            <form><label>Item Name:</label><input class="form-control form-control-sm" type="text" id="itm"
                                                  onkeyup="enter(event)" name="itm"
                                                  value="<?php echo $details['item'] ?>" style="width:100%;">
                <input type="hidden" id="id" name="id" value="<?php echo $_GET['id'] ?>"/>
                <div style="height:30px;"></div>
                <label>Item Design:</label><input class="form-control form-control-sm" onkeyup="enter(event)" id="dsgn"
                                                  name="dsgn" type="text" value="<?php echo $details['design'] ?>"
                                                  style="width:100%;">
                <div style="height:30px;"></div>
                <label>Item Store:</label><input class="form-control form-control-sm" onkeyup="enter(event)" id="stre"
                                                 name="stre" type="text" value="<?php echo $details ['store'] ?>"
                                                 style="width:100%;">
                <div style="height:30px;"></div>
                <div class="btn-group float-right" role="group">
                    <button class="btn btn-danger" type="button" onclick="location.href='cards.php'">Cancel</button>
                    <button class="btn btn-success" onclick="editCard()" type="button">Submit</button>
                </div>
            </form>
        </div>
    </div>
